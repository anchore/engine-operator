...
BUNDLE_IMG ?= anchore-engine-bundle:$(VERSION)
...
ifeq (,$(shell which helm-operator 2>/dev/null))
	...
	curl -sSLo $(HELM_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.4.0/helm-operator_$(OS)_$(ARCH) ;\
